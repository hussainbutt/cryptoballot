...
export const canisterId = process.env.CANISTER_ID_VOTE_VERIFICATION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vote_verification_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vote_verification_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vote_verification_backend.did.js")._SERVICE>}
 */
export const vote_verification_backend = createActor(canisterId);
